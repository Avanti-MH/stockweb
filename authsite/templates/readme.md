    ...
    <body>
        ...
        <div align=center class="container">
            <div class="card justify-content-center" style="width: 18rem;">
                <div>
                    <p></p>
                    <svg style="width:40%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 486.8 486.8" style="enable-background:new 0 0 486.8 486.8;" xml:space="preserve">
                        <g>
                            <g>
    ...
    <body>
        ...
        <div align=center class="container">
            <div class="card justify-content-center" style="width: 18rem;">
                <div>
                    <p></p>
                    <svg style="width:40%" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 310 310" style="enable-background:new 0 0 310 310;" xml:space="preserve">
...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <symbol id="tool" viewBox="0 0 16 16">
    ...
    <div class="px-3 py-2 bg-dark text-white">
      ...
      <div class="container-fluid">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          ...
          <a href="http://140.116.214.156:1985/supRes/support_resistant/" class="d-flex align-items-left my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
            <h2>Support_Resistant</h2>
          </a>
